...
public class BuyServiceImpl implements BuyService{
	...
	public Mono<BuyResponse> buy(BuyRequest buyRequest) {
		...
		Flux<ConvertTable> convert = convertTableRepository.findByConvertionId(buyRequest.getData().getConvertionId());

		// TODO: Maybe error handling? or creation of a new convertion when id or version are incorrect
